...
public partial class MovieEntityDataManager : DbContext
{
    ...
    public virtual DbSet<DIMENSIONCLIENT> DIMENSIONCLIENTs { get; set; }

    public virtual DbSet<DIMENSIONFILM> DIMENSIONFILMs { get; set; }

    public virtual DbSet<DIMENSIONTEMP> DIMENSIONTEMPS { get; set; }
